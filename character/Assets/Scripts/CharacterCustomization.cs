...
public class CharacterCustomization : MonoBehaviour
{
    ...
    public void SaveSelection()
    {
        ...
        {
            playerName = "Pemain"; // nama default
        }


        PlayerPrefs.SetString("PlayerName", playerName);
        PlayerPrefs.SetInt("eyeSelected", eyeSelected);
        PlayerPrefs.SetInt("hairSelected", hairSelected);
        PlayerPrefs.SetInt("coatSelected", coatSelected);
        PlayerPrefs.SetInt("pantsSelected", pantsSelected);
        PlayerPrefs.SetInt("shoesSelected", shoesSelected);
    }
